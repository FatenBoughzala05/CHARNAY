...
export default function PlaceOrderScreen() {
  ...
  const round2 = (num) => Math.round(num * 1000 + Number.EPSILON) / 1000; //123.2345 => 123.23
                ...
                {cart.cartItems.map((item) => (
                  <ListGroup.Item key={item._id}>
                    <Row className="align-items-center">
                      ...
                      <Col md={3}>{item.price.toFixed(3)} TND</Col>
                    </Row>
                  </ListGroup.Item>
                ))}
              </ListGroup>
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Row>
                    <Col>Tax</Col>
                    <Col>{cart.taxPrice.toFixed(3)} TND</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>{cart.totalPrice.toFixed(3)} TND</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
